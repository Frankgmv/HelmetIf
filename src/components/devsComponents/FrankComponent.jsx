...
const FrankComponent = () => {
  return (
    <div className="container_section">
      ...
      <ContentComponent path='frank.png' titulo='Me llamo Frank' contenido={'Soy aquella una persona con una sólida base de conocimientos adquiridos a través de varios proyectos realizados durante sus estudios y diversos programas realizados simultáneamente a estos. Estas experiencias me han proporcionado aptitudes y actitudes valiosas para crear y construir en el sector TI.'} cabezera='Hey‼️' pie='Conece más sobre él' link={'https://www.instagram.com/franko_mv/'} />

      <ContentComponent path='habilidades.png' titulo='¿Y cuales son?' contenido={'La inclinación al autoaprendizaje y aporte de ideas productivas en los retos, ayuda a generar soluciones rápidas y precisas en los entornos profesionales y personales. Mis características principales son la responsabilidad y compromiso, siempre dando lo mejor de sí en cada una de las tareas que realiza en el día a día.'} cabezera='Ahora sus capacidades' pie='Visita su Linkedin' link="https://www.linkedin.com/in/frankgmv/" />
      
      <ListComponent list={['Comunicación Activa', 'Comunicación Receptiva', 'Adaptabilidad', 'Resolución de problemas', 'Excel básico']} path='h_blandasv2.png' titulo='Soft Skills / Habilidades blandas' cabezera='Veamos ahora habilidades' />
