...
const KevinComponent = () => {
  return (
    <div className="container_section">
      ...
      <ListComponent list={['HTML, CSS, JavaScript', 'Nodejs', 'React', 'Manejo de Terminal', 'Git y GitHub', 'Java', 'Bases de datos SQL y No SQL']} path='habilidades.png' titulo='¿Qué habilidades poseeo?' cabezera='Habilidades' pie='Conoce mis proyectos' link="https://github.com/KevaCG" />
